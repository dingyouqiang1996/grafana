...
require (
	...
	google.golang.org/api v0.206.0 // @grafana/grafana-backend-group
...
require (
	...
	google.golang.org/genproto v0.0.0-20241104194629-dd2ea8efbc28 // indirect; @grafana/grafana-backend-group
